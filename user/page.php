<?php
  ...
  $books = $db->query('SELECT id, title, cover, age, pdf, page, publisher FROM books ORDER BY page ASC');
?>
<!DOCTYPE html>
<html>
    <meta charset="utf-8">
    ...
    <li>
      <div class="bookTitle">
        ...
        <dd><span style="font-family:HGP創英角ﾎﾟｯﾌﾟ体;filter:shadow(color=magenta,direction=100)";>
          ...
          $page = $book['page'];
          $page .= "ページ";
            echo htmlspecialchars($page,ENT_QUOTES); ?>
          </dd></div>
      <div class="cover">
        <a href='jump.php?id=<?php echo $book['id']; ?>'>
