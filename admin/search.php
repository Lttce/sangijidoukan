...
try {
    ...
    $stmt = $db->prepare('SELECT id, title, name, returndate FROM lending WHERE  title LIKE ?');
            ...
            <tbody>
                ...
                <?php foreach ($stmt as $row) : ?>
                    <tr>
                        ...
                        <td>
                            <div class="childName"><?php echo $row[2] ?></div>
                        </td>
                        <td>
                            <div class="returnDate"><?php echo $row[3] ?></div>
                        </td>
                        <td>
                            <div class="bookOperation">
                                <input class="listButton" type="button" value="詳細" onclick="location.href='lend-detail.php?id=<?php echo $row[0]; ?>'">&nbsp;
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
